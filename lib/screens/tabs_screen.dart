...
import 'package:task_app/screens/completed_screen.dart';
import 'package:task_app/screens/favoriate_screen.dart';
...
class _TabsScreenState extends State<TabsScreen> {
  final List<Map<String, dynamic>> _pageDetails = [
    ...
    {'pageName': const CompledtedTasksScreen(), 'title': 'Completed Task'},
    {'pageName': const FavoriateTasksScreen(), 'title': 'Favorite Task'}
  ];
